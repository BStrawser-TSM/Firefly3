...
namespace MVC
{
    public static class Views
    {
        ...
        public static class ClientChapter
        {
            public static class ClientChapter_
            {
                public const string ClientChapterIndex = "~/Modules/ClientChapter/ClientChapter/ClientChapterIndex.cshtml";
            }
