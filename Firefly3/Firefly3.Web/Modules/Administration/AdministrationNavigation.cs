...
//using Administration = Firefly3.Administration.Pages;

//[assembly: NavigationMenu(9000, "Administration", icon: "fa-shield")]
//[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: Firefly3.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
