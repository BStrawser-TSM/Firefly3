    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Firefly3 Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to TrueSense Web Apps";
                    public static LocalText SignInButton = "Enter";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Firefly3 Account";
                    ...
                    public static LocalText FormTitle = "Sign up for Firefly3";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Firefly3";
        }
